...
const PillarsSection = () => {
  ...
  const data = [
    { 
      title: "Quantum Rigor", 
      icon: Zap, 
      desc: "Challenging curriculums pushing boundaries in STEM and theoretical sciences." 
    },
    { 
      title: "Empathetic Logic", 
      icon: Heart, 
      desc: "Fusing humanities with technology to create responsible global leaders." 
    },
    { 
      title: "Practical Mastery", 
      icon: Shield, 
      desc: "Hands-on laboratory experience from day one, building real-world solutions." 
    },
  ];
